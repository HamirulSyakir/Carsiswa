package com.forerunner.carzsiswafinal.Adapter;
...
import com.forerunner.carzsiswafinal.Driver.DriverRideRequestsFrag;
...
public class BookingRequestsAdapter extends RecyclerView.Adapter<BookingRequestsAdapter.ActivitiesViewHolder>{
    ...
    private void reloadDriverRideRequestsFragment() {
        ...
        FragmentManager fragmentManager = ((AppCompatActivity) myActivity).getSupportFragmentManager();
