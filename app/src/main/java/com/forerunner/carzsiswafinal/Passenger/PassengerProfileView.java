...
import com.forerunner.carzsiswafinal.Driver.DriverProfileView;
...
//                    }
        ...
        Button supportBtn=findViewById(R.id.ButtonSupport);
        supportBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PassengerProfileView.this, SupportActivity.class);
                startActivity(intent);
            }
        });
