package com.forerunner.carzsiswafinal.Model.firebase;
...
public class Authentication {
    ...
    public static void logIn(String inputEmail, String password, OnSuccessCallback onSuccess,
    ...
    public static void createUser(String inputEmail, String password, OnSuccessCallback onSuccess,
                                     OnFailureCallback onFailure) {
