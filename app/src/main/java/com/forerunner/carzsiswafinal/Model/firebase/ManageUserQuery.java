...
public class ManageUserQuery {
    ...
    public void addDriverToDatabase(Driver driver, OnSuccessCallback onSuccess,
    ...
    public void addPassengerToDatabase(Passenger passenger, OnSuccessCallback onSuccess,
                                        OnFailureCallback onFailure) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
